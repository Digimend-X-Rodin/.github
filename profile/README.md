...
> Its purpose is intended for **personal use** and **unofficial releases**.
...
```
```
git clone https://github.com/Digimend-X-Rodin/packages_apps_DolbyUI.git -b rodin packages/apps/DolbyUI
```
```
